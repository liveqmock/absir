 ...
 */
package com.absir.appserv.system.dao.utils;
...
import com.absir.appserv.jdbc.JdbcAlias;
...
public abstract class QueryDaoUtils {
	 ...
	 * @return
	 */
	public static Query createQuery(Session session, String queryString, List parameters, int firstResult, int maxResults, boolean cacheable) {
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, Object[] conditions, String queue, int firstResult, int maxResults) {
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, Object[] conditions, String queue, int firstResult, int maxResults, boolean cacheable) {
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, String joinAlias, Object[] conditions, String queue, int firstResult, int maxResults, boolean cacheable) {
		if (args == null) {
			args = JdbcAlias.ALIAS;
		}

		List<Object> parameters = new ArrayList<Object>();
		String queryString = JdbcUtils.Driver().selectString(tableAlias(table), args, joinAlias, conditions, queue, 0, 0, parameters);
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, String conditions, List parameters, String queue, int firstResult, int maxResults, boolean cacheable) {
		if (args == null) {
			args = JdbcAlias.ALIAS;
		}
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, JdbcCondition jdbcCondition, int firstResult, int maxResults) {
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, JdbcCondition jdbcCondition, String queue, int firstResult, int maxResults) {
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, JdbcCondition jdbcCondition, String queue, int firstResult, int maxResults) {
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, JdbcCondition jdbcCondition, String queue, int firstResult, int maxResults, boolean cacheable) {
		return selectQuery(session, table, args, jdbcCondition == null ? null : jdbcCondition.getJoinAlias(), jdbcCondition == null ? null : jdbcCondition.getConditionList().toArray(), queue,
				firstResult, maxResults, cacheable);
	}
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, JdbcCondition jdbcCondition, String queue, JdbcPage jdbcPage) {
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, JdbcCondition jdbcCondition, String queue, JdbcPage jdbcPage, boolean cacheable) {
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, String joinAlias, Object[] conditions, JdbcPage jdbcPage) {
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, String joinAlias, Object[] conditions, String queue, JdbcPage jdbcPage) {
	 ...
	 * @return
	 */
	public static List selectQuery(Session session, String table, String args, String joinAlias, Object[] conditions, String queue, JdbcPage jdbcPage, boolean cacheable) {

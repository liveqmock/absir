...
<div class="pageFormContent" layoutH="56">
	<%
		WebJsplDeveloper.setScenario("edit", request);
	...
	%>
	<p>
		<label><%=field.getCaption()%>:</label> <input <%=identifier%>
		...
		<div class="tabsHeader">
			<div class="tabsHeaderContent">
				<ul>
					...
					%>
					<%=identifier + ">"%><a href="javascript:;"><span><%=field.getCaption()%></span></a><%="</li>"%>
					<%
						}
							}
					%>

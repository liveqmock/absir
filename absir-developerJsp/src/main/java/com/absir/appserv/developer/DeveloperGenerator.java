...
public class DeveloperGenerator {
	 ...
	 * @return
	 */
	public static DeveloperGenerator getDeveloperGenerator(HttpServletRequest request) {
	 ...
	 * @return
	 */
	protected static DeveloperGenerator pushDeveloperGenerator(HttpServletRequest request) {
		Stack<DeveloperGenerator> generators = (Stack<DeveloperGenerator>) request.getAttribute(GENERATOR_STACK_KEY);
		if (generators == null) {
	 ...
	 * @param request
	 */
	protected static void popDeveloperGenerator(HttpServletRequest request) {
		Stack<DeveloperGenerator> generators = (Stack<DeveloperGenerator>) request.getAttribute(GENERATOR_STACK_KEY);
		generators.pop();
	}

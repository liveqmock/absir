...
(function($){
	...
	$.taskBar = {
		...
		addDialog: function(id, title){
			...
			if (!task[0]) {
				var taskFrag = '<li id="#taskid#"><div class="taskbutton"><span><i class="fa fa-caret-square-o-down"></i> #title#</span></div><div class="close"><i class="fa fa-times-circle"></i></div></li>';

...
public abstract class OCard<C extends OCard, F extends OFight> extends OObject<C> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.absir.appserv.game.value.OObject#atk()
	 */
	@Override
	public boolean atk() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.absir.appserv.game.value.OObject#fetchTarget()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.absir.appserv.game.value.OObject#addReportDetail(com.absir.appserv

...
<div layoutH="26">
		...
		<form rel="pagerForm" method="post"
			...
			<div class="searchBar">
				<div class="searchFormContent">
					<%
						WebJsplDeveloper.include("bean/search/" + request.getAttribute("entityName") + ".jsp", "search.jsp", pageContext, request, response);
					%>
				</div>
				<div class="subBar">
					<ul>
	...
	<div class="pageContent">
		<table class="table" width="100%" targetType="dialog" layoutH="138">
			<%
				WebJsplDeveloper.include("bean/lookup/" + request.getAttribute("entityName") + ".jsp", pageContext, request, response);
			%>
		</table>
	</div>
</div>

...
<th class="name ${orderFieldMap.name}" orderfield="name">版本名称</th>
<th class="platform ${orderFieldMap.platform}" orderfield="platform">平台</th>
<th class="version ${orderFieldMap.version}" orderfield="version">版本号</th>
...
<td class="version">${entity.version}</td>

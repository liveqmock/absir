    ...
    <?php if(!empty($title)) { foreach($title as $i=>$vo) { ?>
     <div class="form-col">
        ...
        <div class="form-item cf">
            ...
            <div class="controls upload_picture_item" rel="<?php echo ($i); ?>">
                ...
                <div class="upload-img-box">
                  <?php if(!empty($imgId[$i])): ?><div class="upload-pre-item"><img src="/njsp<?php echo (get_cover($imgId["$i"],'path')); ?>"/></div><?php endif; ?>
                </div>
            </div>
            -->

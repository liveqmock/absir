...
$.setRegional("alertMsg", {
	title:{error:"错误", info:"信息", warn:"警告", correct:"成功", confirm:"确认"},
...
var alertMsg = {
    ...
    _fas: {error:"fa-times-circle", info:"fa-info-circle", warn:"fa-exclamation-circle", correct:"fa-check-circle", confirm:"fa-question-circle"},
	...
	_open: function(type, msg, buttons){
		...
		var boxHtml = DWZ.frag["alertBoxFrag"].replace("#type#", type).replace("#fa#", this._fas[type]).replace("#title#", this._getTitle(type)).replace("#message#", msg).replace("#butFragment#", butsHtml);
		...
		var jButs = $(this._boxId).find(".btn");

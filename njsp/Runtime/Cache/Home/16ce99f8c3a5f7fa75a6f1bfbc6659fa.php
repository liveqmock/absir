...
<form id="baseSettingForm" class="edit_module_form form-horizontal">
	<div class="form-item">
        ...
        <div class="controls">
			<select name="template" id="template">
					<option value="simple" <?php if(($template) == "simple"): ?>selected<?php endif; ?> >普通列表模板</option>
                    <option value="underline" <?php if(($template) == "underline"): ?>selected<?php endif; ?> >带下滑线列表模板</option>
                    <option value="lishow" <?php if(($template) == "lishow"): ?>selected<?php endif; ?> >带修饰符列表模板</option>
    ...
    <div class="form-item cf" id="addPicItem">

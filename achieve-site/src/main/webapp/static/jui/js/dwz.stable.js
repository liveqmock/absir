    ...
    $.fn.jTable = function(options){
        return this.each(function(){
            ...
            $("th",thead).each(function(){
                ...
                var oorder = ''; 
                if ($th.hasClass('asc')) {
                    oorder = '<i class="fa fa-chevron-up"></i>';
                }
                if ($th.hasClass('desc')) {
                    oorder = '<i class="fa fa-chevron-down"></i>';
                }
                var alignStyle = $th.attr("align");
                if (alignStyle) {
                ...
                //oorder = '';
                $th.html("<div class='gridCol"+ alignStyle +"' title='"+$th.text()+"'>"+ $th.html() + oorder +"</div>");    
            });
                ...
                $(">th", this).each(function(i){
                    ...
                    $th.mouseover(function(event){
                        ...
                        if($th.outerWidth() - offset < 5) {
                            ...
                            $th.addClass($th.attr("orderField") ? "orderby" : "");
                            $th.unbind("mousedown");
                        }
                        return false;
                    });

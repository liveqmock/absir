<%@page import="com.absir.appserv.feature.menu.IMenuBean"%>
<%@page import="com.absir.appserv.feature.menu.MenuContextUtils"%>
	...
	<ul class="tree treeFolder">
		...
		<li><a
			<%if (menuBean.getUrl() == null)
						out.print(" href=\"" + MenuContextUtils.getAdminRoute() + menuBean.getUrl() + "\" ref=\"" + menuBean.getRef() + "\"");%>><%=menuBean.getName()%></a>
			<ul>
				<%
				...
				<li><a href="<%=menu.getUrl()%>" target="navTab"
					rel="<%=menu.getRef()%>"><%=menu.getName()%></a></li>
				<%
					}
							}
				%>

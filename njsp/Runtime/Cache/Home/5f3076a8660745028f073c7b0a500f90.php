...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>
    ...
    <div class="fl" style="width:50%;">
      <div class="table-bar" style="margin:0">
        <div class="fl">
          <select name="cate" id="cate_select" style="width:150px; height:30px; line-height:30px; margin-bottom:0">
            <option value="0" >全部分类</option>
            <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" 
...
(function(){
  ...
  <script type="text/javascript" src="/njsp/Public/static/jquery.dragsort-0.5.1.min.js"></script> 
  <script type="text/javascript">

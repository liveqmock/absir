...
public abstract class SessionFactoryUtils {
	...
	public static Class<?> getEntityClass(String jpaEntityName) {
		...
		Entry<Class<?>, SessionFactory> entry = sessionFactoryBean.getJpaEntityNameMapEntityClassFactory().get(jpaEntityName);
	 ...
	 * @return
	 */
	public static Class<? extends Serializable> getIdentifierType(String jpaEntityName, Class<?> entityClass, SessionFactory sessionFactory) {
		ClassMetadata classMetadata = getClassMetadata(jpaEntityName, entityClass, sessionFactory);
	 ...
	 * @return
	 */
	public static ClassMetadata getClassMetadata(String jpaEntityName, Class<?> entityClass, SessionFactory sessionFactory) {
	 ...
	 * @return
	 */
	public static Serializable getIdentifierValue(String jpaEntityName, Object entity, Session session, SessionFactory sessionFactory) {
